...
<body>
    ...
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="1" data-background="img/rooms/1.jpg"></div>
            <div class="text-center item bg-img" data-overlay-dark="1" data-background="img/rooms/2.jpg"></div>
            <div class="text-center item bg-img" data-overlay-dark="1" data-background="img/rooms/3.jpg"></div>
            <div class="text-center item bg-img" data-overlay-dark="1" data-background="img/rooms/4.jpg"></div>
        </div>
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="section-title">Room 2</div>
                </div>
                <div class="col-md-8">
