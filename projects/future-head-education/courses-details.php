...
<body class="sticky-header">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <!--=====================================-->
        <section class="course-details-area pad-top-details">
            <div class="container">
                        ...
                        <div class="course-sidebar-3 sidebar-top-position">
                            <div class="edu-course-widget widget-course-summery">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        <h4 class="widget-title">Post Graduate Diploma in Information Technology</h4>
                                        <p class="widget-title">Course Includes:</p>
                                        <ul class="course-item">
                                            <li>
                                                <span class="label"><i class="icon-60"></i>Price:</span>
                                                <span class="value price">₹220000.00</span>
                                            </li>
                                        ...
                                        <div class="buttons-details">
                                            <div class="read-more-btn">
                                                <a href="#" class="edu-btn">Apply Now <i class="icon-4"></i></a>
                                            </div>
                                            <div class="read-more-btn">
                                                <a href="#" class="edu-btn">Download Brochure  <i class="icon-4"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="">
                                <div class="breadcrumb-inner">
                                    ...
                                    <div class="page-title">
                                        <h1 class="title">Post Graduate Diploma in Information Technology,
                                            Admission Process
                                            Scope 2023</h1>
                                    </div>
                        ...
                        <div class="course-details-content">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="carriculam-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false">Admission 2023</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="course-tab-content">
                                        <div class="course-overview">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                ...
                                                cillum dolore eu fugiat nulla pariatur enim ipsam.</p>
                                            <p class="mb--60">Excepteur sint occaecat cupidatat non proident sunt in
                                                culpa qui officia deserunt mollit anim id est laborum. Sed ut
                                                perspiciatis unde omnis iste natus error sit voluptatem accusantium
                                                doloremque laudantium totam rem aperiam.</p>
                                            <h5 class="title">What You’ll Learn?</h5>
                                            <ul class="mb--60">
                                                <li>Learn to use Python professionally, learning both Python 2 & Python
                                                    3!</li>
                                                <li>Build 6 beautiful real-world projects for your portfolio (not boring
                                                    toy apps)</li>
                                            ...
                                            <p>Consectetur adipisicing elit, sed do eiusmod tempor inc idid unt ut
                                                labore et dolore magna aliqua enim ad minim veniam quis nostrud exerec
                                                tation ullamco laboris nis aliquip commodo consequat duis aute irure
                                                dolor.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="carriculam" role="tabpanel"
                                    ...
                                    <div class="course-tab-content">
                                        <div class="course-curriculam">
                                            <h3 class="heading-title">Admission 2023</h3>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                tempor inc idid unt ut labore et dolore magna aliqua enim ad minim
                                                veniam, quis nostrud exerec tation ullamco laboris nis aliquip commodo
                                                consequat.</p>
                                            <div class="course-lesson">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Local Development
                                                            Environment Tools</div>
                                                    ...
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Course Exercise /
                                                            Reference Files</div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Code Editor
                                                            Installation (Optional if you have one)</div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Embedding PHP in HTML
                                                        </div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="course-lesson">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Defining Functions
                                                        </div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i>Function Parameters
                                                        </div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Return Values From
                                                            Functions</div>
                                                        <div class="badge-list">
                                                            <span class="badge badge-primary">0 Question</span>
                                                            <span class="badge badge-secondary">10 Minutes</span>
                                                    ...
                                                    <li>
                                                        <div class="text"><i class="icon-65"></i> Global Variable and
                                                            Scope</div>
                                                        <div class="icon"><i class="icon-68"></i></div>
                                                    </li>
                                                    <li>
                                ...
                                <div class="tab-pane fade" id="instructor" role="tabpanel"
                                    ...
                                    <div class="course-curriculam mb--90 course-tab-content">
                                        <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up"
                                            data-sal-duration="800">Q&A</h3>
                                        <p data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">Lorem ipsum
                                            dolor
                                            sit amet, consectetur adipisicing elit, sed do eiusmod tempor inc idid unt
                                            ut labore
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="course-lesson">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div class="text"><i class="icon-65"></i> Course
                                                                        Overview
                                                                    </div>
                                                                    <div class="icon"><i class="icon-68"></i></div>
                                                                </li>
                                                                <li>
                                                                    <div class="text"><i class="icon-65"></i> Local
                                                                        Development
                                                                        Environment Tools</div>
                                                                    <div class="badge-list">
                                                                        <span class="badge badge-primary">0
                                                                            Question</span>
                                                                ...
                                                                <li>
                                                                    <div class="text"><i class="icon-65"></i> Code
                                                                        Editor
                                                                        Installation (Optional if you have one)</div>
                                                                    <div class="icon"><i class="icon-68"></i></div>
                                                                </li>
                                                                <li>
                                                                    <div class="text"><i class="icon-65"></i> Embedding
                                                                        PHP in
                                                                        HTML</div>
                                                                    <div class="icon"><i class="icon-68"></i></div>
                                                                </li>
                                        ...
                                        <div class="course-review">
                                            ...
                                            <div class="comment-area">
                                                ...
                                                <div class="comment-list-wrapper">
                                                    ...
                                                    <div class="comment">
                                                        <div class="thumbnail">
                                                            <img src="assets/images/blog/comment-01.jpg"
                                                                alt="Comment Images">
                                                        </div>
                                                    ...
                                                    <div class="comment">
                                                        <div class="thumbnail">
                                                            <img src="assets/images/blog/comment-02.jpg"
                                                                alt="Comment Images">
                                                        </div>
                                                        <div class="comment-content">
                                                            <div class="rating">
                                                    ...
                                                    <div class="comment">
                                                        <div class="thumbnail">
                                                            <img src="assets/images/blog/comment-03.jpg"
                                                                alt="Comment Images">
                                                        </div>
                                                        <div class="comment-content">
                                                            <div class="rating">
                                            ...
                                            <div class="comment-form-area">
                                                ...
                                                <form class="comment-form">
                                                    <div class="row g-5">
                                                        ...
                                                        <div class="form-group col-12">
                                                            <textarea name="comm-message" id="comm-message" cols="30"
                                                                rows="5" placeholder="Review summary"></textarea>
                                                        </div>
                                                        <div class="form-group col-12">
                                                            <button type="submit" class="edu-btn submit-btn">Submit
                                                                Review <i class="icon-4"></i></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="edu-course course-style-2 hover-button-bg-white">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="assets/images/home/course-1.jpg" alt="Course Meta">
                                        </a>

                                    </div>
                                    <div class="content">
                                        <span class="course-level">FUTURE HEAD</span>
                                        <h5 class="title">
                                            <a href="#">Lorem ipsum dolor sit amet consectur adipiscing elit</a>
                                        </h5>
                                        <div class="course-dis-flex">
                                            <div class="course-price">$29.00/<small>Year</small> </div>
                                        ...
                                        <ul class="course-meta">
                                            ...
                                            <li><i class="fa-solid fa-calendar-days"></i> 3 Year</li>
                                            <li><i class="fa-solid fa-building-columns"></i> Private</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="course-hover-content">
                                    <div class="content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet consectur adpis elit sed eiusmod tempor incididunt
                                            labore dolore magna aliquaenim.</p>
                                        <ul class="course-meta">
                                            <li><i class="fa-solid fa-location-dot"></i> Chennai</li>
                                            <li><i class="fa-solid fa-calendar-days"></i> 3 Year</li>
                                            <li><i class="fa-solid fa-building-columns"></i> Private</li>
                                        </ul>
                                        <a href="#" class="edu-btn btn-secondary btn-small">View More
                                            <i class="icon-4"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="edu-course course-style-2 hover-button-bg-white">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="assets/images/home/course-2.jpg" alt="Course Meta">
                                        </a>
                        ...
                        <div class="swiper-slide">
                            <div class="edu-course course-style-2 hover-button-bg-white">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="assets/images/home/course-3.jpg" alt="Course Meta">
                                        </a>
                        ...
                        <div class="swiper-slide">
                            <div class="edu-course course-style-2 hover-button-bg-white">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="#">
                                            <img src="assets/images/home/course-4.jpg" alt="Course Meta">
                                        </a>
